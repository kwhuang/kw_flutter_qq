#import "KwFlutterQqPlugin.h"

@interface KwFlutterQqPlugin () <QQApiInterfaceDelegate, TencentSessionDelegate> {
    TencentOAuth* _oauth;
...
@implementation KwFlutterQqPlugin
...
+ (void)registerWithRegistrar:(NSObject<FlutterPluginRegistrar>*)registrar
{
    FlutterMethodChannel* channel = [FlutterMethodChannel
      methodChannelWithName:@"kw_flutter_qq"
            binaryMessenger:[registrar messenger]];
    KwFlutterQqPlugin* instance = [[KwFlutterQqPlugin alloc] init];
